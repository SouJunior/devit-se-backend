...
export class  $npmConfigName1700048466401 implements MigrationInterface {
    name = ' $npmConfigName1700048466401'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "jobs_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "jobTitle" character varying NOT NULL, "jobLevel" character varying NOT NULL, "publicityChannel" character varying NOT NULL, "jobStatus" boolean NOT NULL, "jobFormat" character varying NOT NULL, "contractType" character varying, "salary" character varying, "benefits" character varying, "jobDescription" character varying, "softRequirements" character varying, "hardRequirements" character varying, "devitRating" character varying, "companyName" character varying NOT NULL, "publicationDate" TIMESTAMP NOT NULL, "finishDate" TIMESTAMP, "company_id" uuid NOT NULL, CONSTRAINT "PK_24dc6a8e00afa4c88953432890d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "company_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "companyName" character varying NOT NULL, "companyUserName" character varying NOT NULL, "companyPassword" character varying NOT NULL, "cnpj" character varying NOT NULL, "sector" character varying, "address" character varying NOT NULL, "complement" character varying, "district" character varying, CONSTRAINT "UQ_cf9cc16bd8e1b83b8635b83c64f" UNIQUE ("companyUserName"), CONSTRAINT "PK_ad727d0b2b2f9bc3f78fff1b19a" PRIMARY KEY ("id"))`);
